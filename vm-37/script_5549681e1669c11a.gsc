...
function function_56e9011(room)
{
	...
	self notify("15dc731fa32bd3bb");
	self endon("15dc731fa32bd3bb");
...
{
	self notify("623f777dba6872cd");
	self endon("623f777dba6872cd");
	/#
...
{
	self notify("162d9549c484a518");
	self endon("162d9549c484a518");
...
function function_4747bdd0(time)
{
	...
	self notify("43964a4ce2469f71");
	self endon("43964a4ce2469f71");
...
{
	self notify("142a163a71214804");
	self endon("142a163a71214804");
	self endon(#"disconnect");
	level endon(#"hash_11a3b1e82b21ec58", #"game_over");
	while(true)
	{
...
{
	self notify("7cebad9e3f33da89");
	self endon("7cebad9e3f33da89");
	level waittill(#"hash_7dd47c99b7707b1c");
...
function function_1dfe9126(room)
{
	...
	self notify("611583c60a78fd4d");
	self endon("611583c60a78fd4d");
...
{
	level endon(#"hash_7dd47c99b7707b1c");
	self notify("7fb3ffbd445e16fd");
	self endon("7fb3ffbd445e16fd");
...
{
	level endon(#"hash_7dd47c99b7707b1c");
	self notify("5ab2498ddcd5a2b2");
	self endon("5ab2498ddcd5a2b2");
...
function function_e0548009()
{
	...
	while(isdefined(level.doa.var_6f3d327))
	{
		...
		foreach(badguy in enemies)
		{
			...
			{
				badguy thread namespace_ec06fe4a::function_570729f0();
			}
			if(isvehicle(badguy))
			{
...
function function_b2706226(room)
{
	...
	if(var_30073b02)
	{
		...
		wait(2);
		wavetime = 80 - (getplayers().size * 10);
		level thread namespace_6e90e490::function_c937e51f(wavetime);
		done = 0;
		while(wavetime > 0)
		{
