...
function function_8fef418b()
{
	...
	if(ispointonnavmesh(self.last_valid_position) && distance2dsquared(self.origin, self.last_valid_position) < sqr(var_fab0ffd6) && (sqr(self.origin[2] - self.last_valid_position[2])) < sqr(16))
	{
		return;
	}
