...
function callback_playerdamage(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, var_fd90b0bb, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, boneindex, vsurfacenormal)
{
	...
	if(isplayer(eattacker) && !weapons::ismeleemod(smeansofdeath))
	{
		...
		if(!isdefined(eattacker.var_fd243db7.var_245ad74))
		{
			eattacker util::function_a0d3d36f();
		}
		if(var_8f516911 > 1)
		{
			eattacker.var_fd243db7.var_245ad74.var_1b9146a2++;
		}
		else
		{
			if(isdefined(level.var_b756a21c[shitloc]))
			{
				eattacker.var_fd243db7.var_245ad74.var_801e7b16++;
			}
			else
			{
				eattacker.var_fd243db7.var_245ad74.var_395c5b7d++;
			}
		}
	}
...
function function_f5cfe2b4(einflictor, eattacker, idamage, idflags)
{
	...
	if(isdefined(idamage) && isplayer(idamage) && isalive(idamage))
	{
		...
		{
			idamage playsoundtoplayer(#"hash_14586b7702eea859", idamage);
		}
...
function function_74a5d514(eattacker, idamage, smeansofdeath, weapon, shitloc)
{
	...
	if(isdefined(idamage) && isplayer(idamage) && meleedamage && idamage hasperk(#"hash_153b9c0c558db313"))
	{
