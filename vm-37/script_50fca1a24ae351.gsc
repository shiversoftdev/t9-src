...
/*
	...
	Flags: Linked
*/
function function_470f56e6(origin, ignore)
{
...
function function_ece96728()
{
	...
	self notify("153d1d5f2fff2539");
	self endon("153d1d5f2fff2539");
	...
	while(true)
	{
		...
		level thread function_470f56e6(self.origin, result.activator);
...
function function_ec0b503f(var_499e2f80)
{
	self endon(#"death");
	level endon(#"game_over");
	self notify("be5acf97548b9eb");
	self endon("be5acf97548b9eb");
...
{
	level endon(#"dungeon_cleanup", #"dungeon_destroyed");
	self notify("39e2db222215854");
	self endon("39e2db222215854");
	wait(15);
	level.doa.var_35c4260d = [];
...
{
	self notify("2367dd9899d18ea9");
	self endon("2367dd9899d18ea9");
	self endon(#"disconnect");
...
{
	self notify("259e6542d5a3fc7b");
	self endon("259e6542d5a3fc7b");
	level endon(#"game_over");
