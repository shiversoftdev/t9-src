...
function private function_18f58ab2(item, player, var_bd027dd9, var_d8138db2, itemcount, var_aec6fa7f, slot)
{
	...
	switch(item.var_a6762160.name)
	{
		...
		case "hash_583f1687cefbd3f3":
		{
			pickup = function_55205f34(item, player, var_bd027dd9, var_d8138db2, itemcount, var_aec6fa7f, slot);
			break;
		}
	}
...
/*
	...
	Flags: Private
*/
function private function_55205f34(item, player, var_bd027dd9, var_d8138db2, itemcount, var_aec6fa7f, slot)
{
...
function private function_15d1af86(var_4c42f7cf)
{
	...
	self clientfield::set("carryingUranium", 0);
	self function_53d7badf(0);
	var_d90e0e15 = function_4ba8fde(#"hash_2b4b97f5e4853f12");
...
function private function_3bf6db8b(state, usetrigger)
{
	...
	level.var_64731636 dirtybomb_usebar::function_f0df5702(self, 0);
	if(isarray(usetrigger.assists))
	{
		level.var_64731636 dirtybomb_usebar::function_4aa46834(self, usetrigger.assists.size + 1);
	}
...
function private function_9db99d2f(frac)
{
	if(level.var_64731636 dirtybomb_usebar::is_open(self))
	{
		level.var_64731636 dirtybomb_usebar::function_f0df5702(self, frac);
	}
}
...
function private function_45c10c43(count)
{
	if(level.var_64731636 dirtybomb_usebar::is_open(self))
	{
		level.var_64731636 dirtybomb_usebar::function_4aa46834(self, count);
	}
}
...
function function_afa7ee8d()
{
	...
	level thread function_588a586d(#"hash_3aa45f7379bfb316", level.var_b9f31e66);
}
