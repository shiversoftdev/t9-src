...
function private spawnplayer_internal()
{
	...
	if(isarray(self.var_231881b1))
	{
		foreach(str_scenedef, var_5c8c4fbc in self.var_231881b1)
		{
			if(isdefined(self.var_16672042[str_scenedef]) && self.var_16672042[str_scenedef] != -1)
			{
