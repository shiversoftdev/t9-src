...
function function_5829abe3(attacker, weapon, var_651b6171)
{
	...
	if(!is_true(var_629fbd5c) || is_true(destroyedkillstreak) && isdefined(var_3c727edf.var_3143c814) && util::function_fbce7263(attacker.team, self.team))
	{
...
{
	function_1f9441d7(weapon);
	level.var_b13d1f9b[weapon.name].var_73c59759 = var_73c59759;
}
...
{
	function_1f9441d7(weapon);
	level.var_b13d1f9b[weapon.name].var_83a750f3 = var_73c59759;
}
...
{
	function_1f9441d7(weapon);
	level.var_b13d1f9b[weapon.name].var_cd17d10d = var_cd17d10d;
}
...
{
	function_1f9441d7(weapon);
	level.var_b13d1f9b[weapon.name].var_6e409d37 = var_6e409d37;
}
...
{
	function_1f9441d7(weapon);
	level.var_b13d1f9b[weapon.name].var_9010d9f6 = var_9010d9f6;
}
