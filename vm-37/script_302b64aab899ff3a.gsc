...
function function_a17af3df(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(bwastimejump === 1)
	{
		self function_5d482e78(#"hash_61ce0b7cea532e77");
		if(self.model === #"c_t9_zmb_zombie_light_body2")
		{
			self function_bf9d3071(#"hash_882e5d8c59f40a3");
		...
		{
			self function_bf9d3071(#"hash_5597c38c16f1dbe9");
			self callback::on_shutdown(&function_c88acbea);
		}
	}
	else
	{
		...
		{
			function_c88acbea();
			self function_bf9d3071(#"hash_61ce0b7cea532e77");
		}
		else
		{
			function_c88acbea();
...
function function_c88acbea(params)
{
	if(self.model === #"c_t9_zmb_zombie_light_body2")
	{
		self function_5d482e78(#"hash_882e5d8c59f40a3");
	}
	else if(self.model === #"c_t9_zmb_ndu_zombie_shirtless2" || self.model === #"hash_16837b6c9b7a1881")
	{
		self function_5d482e78(#"hash_5597c38c16f1dbe9");
	}
}
