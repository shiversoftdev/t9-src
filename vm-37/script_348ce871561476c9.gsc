...
{
	level.var_7abaaef1 = getdvarint(#"hash_57d06cd277d610a", 0);
...
{
	self val::set(#"hash_698dcdb18ce4f995", "show_weapon_hud", 0);
...
{
	self val::reset(#"hash_698dcdb18ce4f995", "show_weapon_hud");
...
/*
	...
	Flags: Linked
*/
function function_2979b1be(var_edd69b13)
{
	self endon(#"death", #"disconnect");
	if(isdefined(var_edd69b13) && var_edd69b13 > 0)
	{
		self function_8a945c0e(0);
		self function_8b8a321a(0);
		wait(var_edd69b13);
	...
	if(isdefined(self))
	{
		if(self namespace_67838d10::function_b9370594())
		{
			return;
		}
		self function_8a945c0e(1);
