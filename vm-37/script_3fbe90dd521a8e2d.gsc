...
function result(death, attacker, mod, weapon, var_fd90b0bb, vpoint)
{
	...
	aat_name = weapon aat::getaatonweapon(var_fd90b0bb, 1);
	tier = function_832f84f6(aat_name);
	if(tier < 4 && self.var_6f84b820 === #"special")
	{
		return;
	}
	weapon clientfield::increment_to_player("ammomod_deadwire_proc", 1);
	...
	switch(tier)
	{
		case 0:
		{
			level.var_6f993f47.weapon = var_fd90b0bb;
			s_params = level.var_6f993f47;
			break;
		}
		case 1:
		{
			level.var_620d4080.weapon = var_fd90b0bb;
			s_params = level.var_620d4080;
			break;
		}
		case 2:
		{
			level.var_8ec0ca14.weapon = var_fd90b0bb;
			s_params = level.var_8ec0ca14;
			break;
		}
		case 3:
		{
			level.var_b347489f.weapon = var_fd90b0bb;
			s_params = level.var_b347489f;
			break;
		}
		case 4:
		{
			level.var_9d477dfa.weapon = var_fd90b0bb;
			s_params = level.var_9d477dfa;
			break;
		}
		case 5:
		{
			level.var_7659ca85.weapon = var_fd90b0bb;
	...
	if(self.var_6f84b820 === #"special")
	{
		if(tier >= 4)
		{
			self thread function_e0e02bed(weapon, s_params, tier);
		}
	}
