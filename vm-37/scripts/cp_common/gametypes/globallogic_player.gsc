...
{
	self notify("233d3dcb8e765c1c");
	self endon("233d3dcb8e765c1c");
	waitframe(1);
...
{
	self notify("7048fdd2926e95f5");
	self endon("7048fdd2926e95f5");
	waitframe(1);
...
function finishplayerdamagewrapper(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, boneindex, vsurfacenormal)
{
	...
	{
		params = {#vsurfacenormal:vsurfacenormal, #boneindex:boneindex, #psoffsettime:psoffsettime, #vdamageorigin:vdamageorigin, #shitloc:shitloc, #vdir:vdir, #vpoint:vpoint, #weapon:weapon, #smeansofdeath:smeansofdeath, #idflags:idflags, #idamage:idamage, #eattacker:eattacker, #einflictor:einflictor};
...
function private function_7abbea8e(params)
{
	...
	if(!var_5d3a3f89)
	{
		...
		player finishplayerdamage(params.einflictor, params.eattacker, params.idamage, params.idflags, params.smeansofdeath, params.weapon, params.vpoint, params.vdir, params.shitloc, params.vdamageorigin, params.psoffsettime, params.boneindex, params.vsurfacenormal);
	}
	...
	if(!var_5d3a3f89)
	{
		level thread lui::screen_fade(var_463ffce7, 1, 0, "black", 0);
	}
