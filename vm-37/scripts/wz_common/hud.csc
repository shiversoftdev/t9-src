...
function function_9b9cecdf()
{
	...
	clientfield::register_clientuimodel("hudItems.playerLivesRemaining", #"hud_items", #"hash_6dddb9a20d49665d", 15000, 3, "int", undefined, 0, 0);
	clientfield::register_clientuimodel("hudItems.playerCanRedeploy", #"hud_items", #"hash_116a728dee230334", 15000, 1, "int", undefined, 0, 0);
	...
	clientfield::function_5b7d846d("hudItems.warzone.waveRespawnTimer", #"hash_593f03dd48d5bc1f", #"hash_14384be8ccdfdba9", 15000, 21, "int", undefined, 0, 0);
