...
function function_70daebd0(entity)
{
	...
	if(enemydistsq < sqr(96) && !is_true(entity.var_4b07f09f))
	{
	...
	if(enemydistsq < sqr(256))
	{
		...
		if(enemydistsq < sqr(96) && !entity haspath())
		{
			return true;
		}
	}
...
function function_90da9686(entity)
{
	...
	if(isdefined(entity.favoriteenemy))
	{
		...
		if(distancesquared(entity.origin, entity.favoriteenemy.origin) >= sqr(600) && !is_true(entity.var_cc94acec))
		{
			function_40bf36ef(entity);
		}
		else
...
function private function_2cf71b2(entity)
{
	...
	if(!is_target_valid(entity, entity.favoriteenemy))
	{
		if(isdefined(entity.favoriteenemy))
		{
...
function private function_40bf36ef(entity)
{
	...
	else
	{
		...
		if(!isdefined(goalpos) && entity.favoriteenemy function_dd070839() && isdefined(entity.favoriteenemy.traversestartnode))
		{
...
{
	self notify("10328eec87ba9093");
	self endon("10328eec87ba9093");
	self endon(#"death");
	while(true)
	{
...
{
	self notify("1fd4432e25c9448e");
	self endon("1fd4432e25c9448e");
	self endon(#"death");
	while(true)
	{
		if(isdefined(self.favoriteenemy))
...
function private function_e87d4fff(entity, asmstatename)
{
	...
	if(isplayer(asmstatename.favoriteenemy) && asmstatename.favoriteenemy getstance() == "prone")
	{
