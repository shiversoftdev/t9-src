...
function init()
{
	...
	callback::add_callback(#"hash_25663702210244cc", &function_9c3085c8);
...
function scoreeventplayerkill(data, time)
{
	...
	if(!isdefined(killstreak))
	{
		...
		if(var_9084d6e && isdefined(var_f048a359))
		{
			...
			attacker contracts::function_a54e2068(#"hash_62593ab7c25a27a4");
		}
		...
		else if(var_e020b97e && !var_c3f8aa38 && isdefined(var_af1b39cb) && var_af1b39cb == attacker)
		{
			...
			attacker contracts::function_a54e2068(#"hash_4a30207a6036bed0");
		}
		...
		if(challenges::ishighestscoringplayer(victim))
		{
			...
			attacker activecamo::function_896ac347(weapon, #"hash_39ab7cda18fd5c74", 1);
			attacker contracts::function_a54e2068(#"hash_30ea14a4ce0e5d04");
		}
		...
		{
			if(weapon != getweapon(#"hash_4bb2d7f789b561eb") && gettime() > (isdefined(attacker.var_5069fdec) ? attacker.var_5069fdec : int(-30 * 1000)) + (int(30 * 1000)))
			{
		...
		if(is_weapon_valid(meansofdeath, weapon, weaponclass, killstreak))
		{
			...
			if(var_dca08887 > weap_min_dmg_range)
			{
				...
				if(weapon.rootweapon.name == "hatchet")
				{
					...
					attacker contracts::function_a54e2068(#"hash_212c4ede1f826312");
				}
			...
			data.results.var_adfa5654 = killdistance;
		...
		if(isalive(attacker))
		{
			if(attacker.health < attacker.maxhealth * 0.35)
			{
				...
				if(weapon.statname === #"knife_loadout")
				{
					if(!isdefined(attacker.pers[#"hash_a76b72a1337af75"]))
					{
						attacker.pers[#"hash_a76b72a1337af75"] = 0;
					}
					attacker.pers[#"hash_a76b72a1337af75"]++;
					if(attacker.pers[#"hash_a76b72a1337af75"] == 3)
					{
						attacker stats::function_d0de7686(#"hash_13bfd2d169c03691", 1, #"hash_20ba08b29e1de57e");
					}
				}
			}
		}
	...
	switch(weapon.rootweapon.name)
	{
		case "hatchet":
		{
			...
			attacker contracts::function_a54e2068(#"hash_677d9e70134fd9f5");
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if(baseweapon == level.weaponspecialcrossbow || weapon.isballisticknife || baseweapon == level.var_9e188c0b)
							{
								valid_weapon = 1;
							}
						}
...
function updatemultikills(weapon, weaponclass, killstreak, victim, time, meansofdeath)
{
	...
	if(!isdefined(killstreak))
	{
		...
		{
			function_644d867a(self, time, (#"multikill_" + self.recentkillcount) + "_nostat");
		}
	}
	if(is_true(baseweapon.var_b76e0a09) || is_true(baseweapon.var_76ce72e8))
	{
		self.var_311e32f++;
	...
	if(secondary_weapon.statname === #"knife_loadout" || primary_weapon.statname === #"knife_loadout")
	{
		if(meansofdeath === "MOD_EXECUTION")
		{
			if(!isdefined(self.pers[#"hash_33dcd1468cbdb9c2"]))
			{
				self.pers[#"hash_33dcd1468cbdb9c2"] = 0;
			}
			self.pers[#"hash_33dcd1468cbdb9c2"]++;
			if(self.pers[#"hash_33dcd1468cbdb9c2"] == 2)
			{
				self stats::function_d0de7686(#"hash_2dc09a051d45038d", 1, #"hash_653135ec012bf674");
			}
		}
	}
	...
	{
		processscoreevent(#"hash_5950ec5208dfe10a", self, victim, level.var_507570e9);
	...
	if(self.var_b27d41c0 >= 2)
	{
		if(isdefined(self.var_eed94074.var_615e1be9))
		{
			...
			{
				processscoreevent(#"hash_4bdbc016764205f3", self, victim, getweapon(#"weapon_armor"));
...
function updateoneshotmultikills(victim, weapon, firsttimedamaged, meansofdeath, time)
{
	...
	else if(weapon.statindex != level.var_bb448b5f.statindex)
	{
		...
		if(meansofdeath == "MOD_HEAD_SHOT")
		{
			self stats::function_dad108fa(#"hash_4db8a1f607f40ac1", 1);
		}
	}
	self.oneshotmultikills = 0;
}
...
{
	baseweapon = weapons::getbaseweapon(weapon);
	return is_true(baseweapon.var_b76e0a09) || is_true(baseweapon.var_76ce72e8);
}
...
function function_c28e2c05(var_152c14d0, var_f208fb92, var_e13a103a)
{
	...
	foreach(sensor in var_f208fb92)
	{
		...
		if(distancesquared(var_152c14d0, sensor.origin) < sqr((function_f99d2668() ? 2400 : 800) + 50))
		{
			return sensor;
		}
	}
