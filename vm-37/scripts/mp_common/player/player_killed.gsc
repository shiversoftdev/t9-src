...
function callback_playerkilled(einflictor, attacker, idamage, smeansofdeath, weapon, var_fd90b0bb, vdir, shitloc, psoffsettime, deathanimduration, enteredresurrect)
{
	...
	var_a44c7fd8 = {#hash_10d87328:function_f8d53445(), #shitloc:shitloc, #vdir:vdir, #hash_fd90b0bb:var_fd90b0bb, #weapon:weapon, #smeansofdeath:smeansofdeath, #idamage:idamage, #hash_83634238:(isplayer(vattacker) ? vattacker getplayerangles() : vattacker.angles), #attackerorigin:vattacker.origin, #attacker:attacker, #einflictor:einflictor, #victimweapon:self.currentweapon, #hash_5fceefd4:self getplayerangles(), #victimorigin:self.origin};
...
function private function_c220950f(var_c391d0a8, idamage, weapon_at_time_of_death)
{
	...
	if(isplayer(var_c391d0a8.attacker))
	{
		...
		if(killstreaks::is_killstreak_weapon(weapon))
		{
			...
			bb::function_c3b9e07f(var_c391d0a8.attacker, attacker_origin, var_a48b1a67, weapon.name, self, self.origin, var_76d450bd, var_c144d535, idamage, var_c391d0a8.smeansofdeath, var_c391d0a8.shitloc, 1, killstreak);
		}
		else
		{
			bb::function_c3b9e07f(var_c391d0a8.attacker, attacker_origin, var_a48b1a67, weapon.name, self, self.origin, var_76d450bd, var_c144d535, idamage, var_c391d0a8.smeansofdeath, var_c391d0a8.shitloc, 1, undefined);
		}
	}
	else
	{
...
function private post_game_death(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime, deathanimduration)
{
	...
	if(isdefined(body))
	{
		...
		var_a2f12b49 = {#hash_10d87328:function_f8d53445(), #shitloc:psoffsettime, #vdir:shitloc, #weapon:vdir, #smeansofdeath:weapon, #idamage:smeansofdeath, #hash_83634238:(isplayer(vattacker) ? vattacker getplayerangles() : vattacker.angles), #attackerorigin:vattacker.origin, #attacker:idamage, #einflictor:attacker, #victimweapon:self.currentweapon, #hash_5fceefd4:self getplayerangles(), #victimorigin:self.origin};
