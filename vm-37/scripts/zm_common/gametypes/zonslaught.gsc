...
event main(eventstruct)
{
	...
	level.aat_in_use = 1;
	level.var_ae22a03 = [9:#"hash_3aabbe0c0bb97a9b", 8:#"mp_raid_rm", 7:#"mp_nuketown6", 6:#"mp_tundra", 5:#"mp_tank", 4:#"mp_satellite", 3:#"mp_moscow", 2:#"mp_miami", 1:#"mp_kgb", 0:#"mp_cartel"];
