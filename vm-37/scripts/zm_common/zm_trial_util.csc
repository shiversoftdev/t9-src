...
function private finalize_clientfields(localclientnum)
{
	...
	clientfield::register_clientuimodel("zmhud.currentWeaponLocked", #"zm_hud", #"hash_55ee0b83b5104f3c", 1, 1, "int", undefined, 0, 0);
	clientfield::register_clientuimodel("zmhud.currentEquipmentLocked", #"zm_hud", #"hash_5e47afd5beefedac", 16000, 1, "int", undefined, 0, 0);
	clientfield::register_clientuimodel("zmhud.currentSpecialLocked", #"zm_hud", #"hash_667078ad4853eaff", 16000, 1, "int", undefined, 0, 0);
	for(i = 0; i < 5; i++)
	{
