...
function function_d138afd9()
{
	...
	if(roll > 45)
	{
		level doa_pickups::itemspawn(doa_pickups::function_6265bde4("zombietron_nuke"), spot + (randomintrange(-40, 40), randomintrange(-40, 40), 0), undefined, undefined, 1);
	}
	if(roll > 55)
	{
		level doa_pickups::itemspawn(doa_pickups::function_6265bde4("zombietron_boost"), spot + (randomintrange(-40, 40), randomintrange(-40, 40), 0), undefined, undefined, 1);
	}
	if(roll > 65)
	{
	...
	if(roll > 75)
	{
		level doa_pickups::itemspawn(doa_pickups::function_6265bde4("zombietron_skeleton_key"), spot + (randomintrange(-40, 40), randomintrange(-40, 40), 0), undefined, undefined, 1);
	}
	if(roll > 85)
	{
		level doa_pickups::itemspawn(doa_pickups::function_6265bde4("zombietron_umbrella"), spot + (randomintrange(-40, 40), randomintrange(-40, 40), 0), undefined, undefined, 1);
	}
	if(roll > 95)
	{
		level doa_pickups::itemspawn(doa_pickups::function_6265bde4("zombietron_extra_life"), spot + (randomintrange(-40, 40), randomintrange(-40, 40), 0), undefined, undefined, 1);
	}
}
