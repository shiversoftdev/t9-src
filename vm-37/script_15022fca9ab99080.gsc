...
/*
	...
	Flags: None
*/
function function_11fa7e00(killstreak_type, original_team, killstreak_id)
{
	if(self.var_b8f3aeed !== 1)
	{
		self killstreakrules::killstreakstop(killstreak_type, original_team, killstreak_id);
		self.var_b8f3aeed = 1;
	}
}
...
function watch_shutdown(driver)
{
	...
	function_68a07849(vehicle.weapon, driver);
}
