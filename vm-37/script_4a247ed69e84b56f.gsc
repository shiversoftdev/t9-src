...
{
	self notify("7cbcad28f517d9c");
	self endon("7cbcad28f517d9c");
...
{
	self notify("de98add00d67d52");
	self endon("de98add00d67d52");
	level endon(#"game_over");
...
{
	self notify("2d88e7b4e355d085");
	self endon("2d88e7b4e355d085");
	level endon(#"game_over");
