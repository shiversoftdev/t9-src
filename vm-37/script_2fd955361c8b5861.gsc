...
function function_1479a342(attacker, weapon)
{
	...
	foreach(ai in var_8345897c)
	{
		...
		n_damage = mapfloat(0, var_62aaf679.explosionradius, var_62aaf679.explosionouterdamage, var_62aaf679.explosioninnerdamage, n_dist);
		ai dodamage(int(n_damage), v_origin, weapon, undefined, "none", "MOD_EXPLOSIVE", 0, var_62aaf679);
		var_84d440a5++;
		if(var_84d440a5 > 1)
		{
			waitframe(1);
