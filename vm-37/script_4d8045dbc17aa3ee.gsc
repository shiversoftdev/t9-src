...
function devguithink()
{
	...
	while(true)
	{
		...
		switch(cmd)
		{
			...
			{
				player = getplayers()[0];
				level doa_pickups::function_d080f0db(doa_pickups::function_6265bde4(getdvar(#"hash_4e8b5bae739da5a", "zombietron_lmg")), player.origin, undefined, undefined, 1, undefined, undefined, undefined, player);
				break;
			}
		}
		setdvar(#"zombie_devgui", "");
...
{
	self notify("4d08e9bb22f8629c");
	self endon("4d08e9bb22f8629c");
...
{
	self notify("4589b4dd17b9f216");
	self endon("4589b4dd17b9f216");
	...
	while(true)
	{
		...
		y = y + 40;
		if(is_true(level.doa.var_e230dc1d))
		{
...
{
	self notify("307669f5cdc31a96");
	self endon("307669f5cdc31a96");
...
{
	self notify("32e2947f9af16687");
	self endon("32e2947f9af16687");
	level endon(#"hash_39ebcccef3aa05c6", #"game_over");
...
function function_ddde8af6(delay)
{
	...
	self notify("71ee89fc209f6ed2");
	self endon("71ee89fc209f6ed2");
...
{
	self notify("9a7544ae47cb06c");
	self endon("9a7544ae47cb06c");
...
{
	self notify("13e5f5d038161d05");
	self endon("13e5f5d038161d05");
	level endon(#"hash_12d79bc0fed4ee5a");
...
{
	self endon(#"disconnect");
	self notify("33cf9b9085be0f5d");
	self endon("33cf9b9085be0f5d");
	level endon(#"hash_12d79bc0fed4ee5a");
	if(randomint(100) > 70)
	{
...
{
	self notify("42077119787563be");
	self endon("42077119787563be");
...
{
	self notify("4a06791d6c013a40");
	self endon("4a06791d6c013a40");
	level waittill(#"hash_12d79bc0fed4ee5a");
...
{
	self notify("4d312a9ac48a020c");
	self endon("4d312a9ac48a020c");
...
{
	self notify("794ee8c064e9e410");
	self endon("794ee8c064e9e410");
