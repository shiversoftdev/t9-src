...
function private function_e3e0feb5(localclientnum, localplayer)
{
	...
	foreach(player in players)
	{
		...
		player function_158c76b1(localclientnum, weapon, "tag_weapon_right", var_d1a848d9, 1, weaponoptions);
	}
}
...
function private function_f77ced93(params)
{
	...
	var_d1a848d9 = function_5442be13(weaponoptions);
	self function_158c76b1(localclientnum, weapon, "tag_weapon_right", var_d1a848d9, 1, weaponoptions);
}
...
function private function_7bbf0553(localclientnum, eventstruct)
{
	...
	self function_158c76b1(localclientnum, eventstruct.weapon, eventstruct.tagname, var_d1a848d9, 0, eventstruct.var_6f2ae9c0);
}
...
/*
	...
	Flags: Linked, Private
*/
function private function_158c76b1(localclientnum, weapon, tagname, var_d1a848d9, var_d71e8c6e, var_6f2ae9c0)
{
