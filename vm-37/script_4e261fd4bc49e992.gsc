...
function init_clientfields()
{
	...
	clientfield::register("scriptmover", "infiltration_plane", 1, 2, "int", &function_1f7ab61a, 0, 0);
	clientfield::register("scriptmover", "infiltration_ent", 1, 2, "int", &function_20c7ffc9, 0, 0);
