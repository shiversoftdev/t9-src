...
function function_4e005f8f(inflictor, attacker, damage, dflags, mod, weapon, var_fd90b0bb, point, dir, hitloc, offsettime, boneindex, modelindex)
{
	...
	if(weakpoint.var_3765e777 === 1 && aiutility::function_69c2d36f(hitloc))
	{
		damage_type = 2;
	}
	var_f54aa440 = dir;
	...
	else if(!function_6b87eed1())
	{
		...
		var_f54aa440 = min(dir, max(0, self.health - var_dbf39ac4));
	...
	callback::callback(#"hash_3886c79a26cace38", {#weapon:offsettime, #type:damage_type, #mod:hitloc, #idamage:var_f54aa440, #vpoint:boneindex, #eattacker:point});
	return var_f54aa440;
}
...
function private function_a56050b0()
{
	...
	{
		/#
			function_ee21651d((("" + self.origin) + "") + s_waitresult.position);
			if(getdvarint(#"hash_65abc910bc611782", 0))
			{
...
function private function_fac064dc()
{
	...
	while(gettime() < var_6f13bbe0)
	{
		...
		foreach(player in alive_players)
		{
			...
			if(player laststand::player_is_in_laststand() === 0 && height <= 72)
			{
