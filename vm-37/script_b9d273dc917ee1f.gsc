...
function private on_ai_killed(params)
{
	...
	if(isdefined(level.var_fa1d4366) || (self.var_6f84b820 === #"special" || self.var_6f84b820 === #"elite" && isplayer(params.eattacker) && (level.var_df1d1235 >= 4 || math::cointoss(10))) && (zm_utility::check_point_in_playable_area(self.origin) || is_true(level.onslaught_game)))
	{
