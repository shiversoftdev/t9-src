...
function function_123bcbcf()
{
	...
	switch(self.var_9e09931e)
	{
		...
		case 4:
		{
			...
			var_1ec27fb6 = getweapon(#"hash_3fa91d1674123e09");
			if(!isdefined(var_1ec27fb6) || var_1ec27fb6 == level.weaponnone || self hasweapon(var_1ec27fb6))
			{
			...
			switch(str_reward)
			{
				...
				case "shockwave":
				{
					self thread function_11be5095(5, 10, 0, #"hash_3fa91d1674123e09");
					break;
				}
				case "free_perk":
				{
...
function function_d36fb590(var_aa4f9213, var_6c9485fc, n_fx_type)
{
	...
	var_9ac46b0e = self.var_642ed51a.var_f693bf0b.angles;
...
function private function_ff6232b7()
{
	...
	wait(13);
	item_world::function_7730442c(self, 1);
}
...
function private function_6725ddf1(str_item_name)
{
	...
	{
		if(isdefined(level.var_f726653d[str_item_name]))
		{
			str_item_name = level.var_f726653d[str_item_name];
		}
	}
	else
	{
...
function get_weapon(var_7ed75e97)
{
	if(isdefined(level.var_29d88fe5) && isdefined(level.zombie_weapons))
	{
		if(!isdefined(level.var_605e404c))
		{
			...
			foreach(var_2d4b1e93 in var_bcb39afb)
			{
...
function function_e2a25377(str_weapon_name, b_upgraded, str_item_name)
{
	...
	if(isdefined(str_item_name))
	{
		...
		if(isdefined(point.var_a6762160.var_a53e9db0))
		{
			...
			dropitem hide();
			self zm_weapons::function_98776900(dropitem, 0, 0);
		}
		else
		{
			self zm_weapons::function_98776900(point, 0, 0);
		}
...
function give_perk_reward(var_16c042b8, var_6c9485fc)
{
	...
	var_4d0b3b87 = util::spawn_model(var_242c6a7b, var_8b84b3ce, var_9ac46b0e);
	self.var_642ed51a.var_f693bf0b clientfield::set("" + #"hash_653b5827e6fbe5f9", 1);
	self.var_642ed51a.var_f92a5f81 = var_4d0b3b87;
...
function function_c2e444e6(str_type, n_amount, var_b492d948, var_6c9485fc, var_10ad9538)
{
	...
	{
		var_814059b6 = function_83132977(str_item_name);
		var_4d0b3b87 = util::spawn_model(var_814059b6.str_model, var_8b84b3ce, var_9ac46b0e);
	...
	{
		var_4d0b3b87 = util::spawn_model(str_model, var_8b84b3ce, var_9ac46b0e);
		self.var_642ed51a.var_f693bf0b clientfield::set("" + #"hash_653b5827e6fbe5f9", 1);
	}
