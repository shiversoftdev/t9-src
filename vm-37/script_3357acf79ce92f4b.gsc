...
function private function_4645d5f8(params)
{
	...
	while(true)
	{
		...
		switch(waitresult._notify)
		{
			case "gunshot":
			{
				self callback::callback(#"hash_184965470b4be191", {#position:waitresult.position, #entity:waitresult.suppressor, #type:0});
				break;
			}
			case "explode":
			{
...
function function_fa6e010d()
{
	...
	while(true)
	{
		if((self getentitynumber() & 1) == (function_8168c82a() & 1) || flag::get(#"hash_624e5d5dfb7f742b"))
		{
			/#
...
{
	if(distancesquared(entity.origin, var_49413202.position) < sqr(256))
	{
