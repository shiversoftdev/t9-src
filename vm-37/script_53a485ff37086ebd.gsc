...
function function_74872db6()
{
	...
	if(level.round_number > 0 && (level.round_number % 3) == 0)
	{
		...
		math::clamp(level.var_d041f60d, 5, 30);
...
function private function_52203507()
{
	...
	{
		if(isdefined(self.var_5f356773) && self.var_5f356773 > 0 && isalive(self))
		{
...
{
	if(level flag::get("cranked_pause") || isgodmode(self) || self isinmovemode("noclip", "ufo"))
	{
		return true;
	}
	return false;
