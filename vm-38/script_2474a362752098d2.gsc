...
*/
function private autoexec function_6ee77dc6()
{
	level notify(-665236592);
}
...
{
	self notify("2929b7a7d6933bc8");
	self endon("2929b7a7d6933bc8");
...
{
	mytrigger = level.doa.var_f4a69294[self.doa.color];
	return self istouching(mytrigger) && mytrigger.var_806ce8f == self.doa.var_96175d8a;
}
	...
	if(isdefined(targ))
	{
		switch(targ.var_d6118311)
		{
			case 2:
			{
				...
				namespace_7f5aeb59::function_f8645db3(getdvarint(#"hash_e363c15517e89db", 75));
			}
			case 1:
			{
			...
			case 4:
			{
				...
				level thread doa_fate::function_42b0778(targ, player, undefined);
				break;
			}
			case 9:
			{
			...
			case 7:
			{
				if(is_true(targ.locked))
				{
					...
					#/
					targ.var_cbff4088--;
					var_370ac26d = getdvarint(#"hash_e363c15517e89db", 75);
					if(targ.var_d6118311 == 6)
					{
						...
						else if(targ.var_cbff4088 == 0)
						{
							...
							var_370ac26d = getdvarint(#"hash_652d85e0bde549ad", 250);
						}
					}
					if(targ.var_cbff4088 > 0)
					{
