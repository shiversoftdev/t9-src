...
function function_cfcd9b92(var_5b36f17f, var_efccf092, var_b04adac9, var_8ab7d27b, var_c1c8f1d, var_ef1623ea)
{
	...
	if(!namespace_61e6d095::exists(#"hash_57cba60410267bed"))
	{
		...
		namespace_61e6d095::function_d5ea17f0(#"hash_57cba60410267bed", var_efccf092);
...
function function_9c8d2a44(update_msg)
{
	if(namespace_61e6d095::exists(#"hash_57cba60410267bed"))
	{
		namespace_61e6d095::function_d5ea17f0(#"hash_57cba60410267bed", update_msg);
	}
}
...
function private function_e782b221(start_time, var_8ab7d27b, var_c1c8f1d, var_ef1623ea)
{
	...
	namespace_61e6d095::function_7f9d1ac4(#"hash_57cba60410267bed", run_time);
	start_time = run_time;
	var_da7e097b = -1;
	var_469ff952 = 0;
	while(run_time >= 0)
	{
		...
		if(var_8ab7d27b)
		{
			...
			{
				var_469ff952 = 1;
				namespace_61e6d095::function_d5ea17f0(#"hash_57cba60410267bed", var_c1c8f1d);
			}
