...
class class_744b99c 
{
	...
	*/
	...
	{
		self notify("4adad81da8edf27a");
		self endon("4adad81da8edf27a");
	...
	*/
	...
	{
		self notify("765e05128f62b5a9");
		self endon("765e05128f62b5a9");
		teleporter = self;
	...
	*/
	...
	{
		self notify("4f95980681090c8");
		self endon("4f95980681090c8");
		self endon(#"disconnect");
	...
	*/
	...
	{
		self notify("3728e0ea2657c6e5");
		self endon("3728e0ea2657c6e5");
		self endon(#"deactivate");
		self triggerenable(1);
...
*/
function private autoexec function_f87658cb()
{
	level notify(1254464582);
}
...
{
	self notify("6f311c755bbced17");
	self endon("6f311c755bbced17");
...
{
	self notify("e1a056f407d58ea");
	self endon("e1a056f407d58ea");
	self endon(#"death");
	wait(5);
...
{
	self notify("134d39c538cf5063");
	self endon("134d39c538cf5063");
	self endon(#"death");
...
function function_904157ac(radius, baseorigin)
{
	...
	self notify("6e1c3eb82afb0f9a");
	self endon("6e1c3eb82afb0f9a");
...
{
	self notify("49b40e9399d4fa5d");
	self endon("49b40e9399d4fa5d");
...
{
	self notify("6d193af3f41c6452");
	self endon("6d193af3f41c6452");
	level endon(#"hash_325440d5433be263");
	level endon(#"game_over");
