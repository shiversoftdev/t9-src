...
*/
function private autoexec function_9dfdc4d8()
{
	level notify(2141739391);
}
...
function function_8b313976(var_c1c9cf07)
{
	...
	switch(var_3abc663e)
	{
		...
		case "hash_38c08136902fd553":
		{
			return self function_33d837e4(n_tier);
		}
	}
	return 0;
}
...
/*
	...
	Flags: Linked
*/
function function_33d837e4(n_level)
{
	...
	if(self function_6c32d092(#"hash_59dbe7f72baaa0f0") && n_level <= 4)
	{
		return true;
	}
	if(self function_6c32d092(#"hash_59dbeef72baaacd5") && n_level <= 3)
	{
		return true;
	}
	if(self function_6c32d092(#"hash_59dbedf72baaab22") && n_level <= 2)
	{
		return true;
	}
	if(self function_6c32d092(#"hash_59dbecf72baaa96f") && n_level <= 1)
	{
		return true;
	}
	if(self function_6c32d092(#"hash_38c08136902fd553") && n_level == 0)
	{
		return true;
	}
	return false;
