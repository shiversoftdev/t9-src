...
event main(eventstruct)
{
	...
	namespace_9ff9f642::function_9d45c058(#"hash_4c291cb570b90c2e", 6, 9999);
...
function function_452e5ad6()
{
	...
	var_61c941e8 = array::random(var_1a672bba);
	if(var_61c941e8.script_noteworthy === #"hash_5032b84b6481f0b9")
	{
		var_61c941e8.origin = (-2335.62, 11589.8, -278);
	}
	if(var_61c941e8.script_noteworthy === #"hash_5032b74b6481ef06")
	{
		var_61c941e8.origin = (-2481.43, 11584.8, -285);
	}
	if(var_61c941e8.script_noteworthy === #"hash_5032ba4b6481f41f")
	{
		var_61c941e8.origin = (-1209.13, 11597.9, -284.75);
	}
	return var_61c941e8;
}
...
function function_6f6cc58(e_player)
{
	...
	{
		if(self.archetype === #"zombie" || self.archetype === #"hash_1bc8194446d4722f")
		{
...
function private function_859fa480(n_round)
{
	...
	namespace_c3287616::function_cc103b38(#"mechz", n_round);
...
function private function_9e6f187d(n_round)
{
	...
	namespace_c3287616::function_376e51ef(#"raz", n_round);
...
{
	namespace_c3287616::function_2876740e(#"hash_1bc8194446d4722f", &function_44d45595);
	namespace_c3287616::function_376e51ef(#"hash_1bc8194446d4722f", n_round);
}
...
function function_f37d9da7()
{
	...
	level flag::wait_till(#"hash_59ac14b84774eea9");
	foreach(node in var_23a64dc)
	{
...
function private function_8c581f55()
{
	...
	scene::add_scene_func(#"hash_5979ce2c5015434c", &function_388594e2, "play");
	scene::add_scene_func(#"hash_41d095edc8f3ea84", &function_adcf116f, "play");
	scene::add_scene_func(#"hash_3f9d9d2a2a89dd25", &function_388594e2, "play");
	scene::add_scene_func(#"hash_74c69130746c4bad", &function_adcf116f, "play");
	scene::add_scene_func(#"hash_5979ce2c5015434c", &function_1ad17524, "done");
	scene::add_scene_func(#"hash_41d095edc8f3ea84", &function_5d303617, "done");
	scene::add_scene_func(#"hash_3f9d9d2a2a89dd25", &function_1ad17524, "done");
	scene::add_scene_func(#"hash_74c69130746c4bad", &function_5d303617, "done");
...
function private function_bf105732(var_4a8bf1a3)
{
	...
	{
		if(!level.var_e1b1f602 scene::is_playing(#"hash_5979ce2c5015434c") && !level.var_3c41ed40 scene::is_playing(#"hash_3f9d9d2a2a89dd25"))
		{
			level function_66dff432(1);
			function_18a5cf8b(level.var_4a7e5bf7);
			if(function_9c91ed70())
			{
				level.var_3c41ed40 thread scene::play(#"hash_3f9d9d2a2a89dd25", level.var_4a7e5bf7);
			}
			else
			{
				level.var_e1b1f602 thread scene::play(#"hash_5979ce2c5015434c", level.var_4a7e5bf7);
			}
		}
	}
	else if(!level.var_d05c528b scene::is_playing(#"hash_41d095edc8f3ea84") && !level.var_93504ea8 scene::is_playing(#"hash_74c69130746c4bad"))
	{
		level function_66dff432(0);
		function_18a5cf8b(level.var_9351a555);
		if(function_9c91ed70())
		{
			level.var_93504ea8 thread scene::play(#"hash_74c69130746c4bad", level.var_9351a555);
		}
		else
		{
			level.var_d05c528b thread scene::play(#"hash_41d095edc8f3ea84", level.var_9351a555);
		}
	}
}
...
{
	if(!level.var_d05c528b scene::is_playing(#"hash_41d095edc8f3ea84") && !level.var_93504ea8 scene::is_playing(#"hash_74c69130746c4bad"))
	{
...
{
	zombie = zm_utility::function_cce73165("riser_location", #"hash_7613c8395a7cd724", #"hash_5e00a9dba61e034");
				...
				if(zombie istouching(self))
				{
					if(zombie.archetype === #"mechz")
					{
						...
						if(zombie.health > 0)
						{
							...
							zombie namespace_e0710ee6::function_a8dc3363(locs);
						}
						continue;
					}
...
function function_419047b9()
{
	...
	namespace_c3287616::function_b4a8f95a(#"hash_1bc8194446d4722f", level.var_6103ecd9, &special_round_start, &special_round_end, &namespace_abfee9ba::function_44d45595, &function_dd0b40e0, 0);
}
...
function private function_9feaaed()
{
	...
	{
		namespace_c3287616::function_d36196b1(15);
	}
	else if(isdefined(level.var_6103ecd9))
	{
		namespace_c3287616::function_d36196b1(level.var_6103ecd9);
	}
	function_efb7d5c9();
}
...
function special_round_end(var_d25bbdd5)
{
	...
	function_e2610c23();
	var_891da4a6 = function_a1ef346b();
	var_891da4a6 = function_a1ef346b();
	if(isdefined(var_891da4a6[0]))
	{
		level thread zm_powerups::specific_powerup_drop("full_ammo", var_891da4a6[0].origin);
	}
...
function function_90cffb5b(var_f52c2c29)
{
	...
	foreach(str_rappel in var_f52c2c29)
	{
		...
		var_491fd46e = getclosestpointonnavmesh(rappel.origin, 64, 16);
		...
		str_zone = zm_zonemgr::get_zone_from_position(var_491fd46e, 1);
		...
		if(isdefined(str_zone) && isdefined(var_5f3b05e8))
		{
			...
			level.var_141e4a5f[var_5f3b05e8][str_zone] = {#hash_db90fcba:var_db90fcba, #hash_491fd46e:var_491fd46e, #rappel:rappel};
		}
	}
}
		...
		foreach(zombie in var_b8855d07)
		{
			...
			if(zombie.favoriteenemy === self)
			{
				if(isdefined(zombie.var_29656770) && zombie.var_29656770.var_990bf66b === var_5f3b05e8)
				{
					...
					zombie.var_29656770.var_c61e7ea7 = var_5f3b05e8;
					continue;
				}
				...
				if(isdefined(str_zone) && isdefined(level.var_141e4a5f[var_5f3b05e8][str_zone]))
				{
					...
					if(distancesquared(zombie.origin, rappel.origin) < max_dist_sq)
					{
						...
						#/
						zombie.var_29656770 = {#hash_c61e7ea7:var_5f3b05e8, #hash_178696d:var_71c80ceb.var_491fd46e, #hash_990bf66b:str_zone};
...
function function_85dc9b9d()
{
	...
	{
		waitresult = undefined;
		waitresult = self waittill(#"hash_2d4daa9e80b86b60", #"goal", #"bad_path");
		...
		if(str_zone === self.var_29656770.var_c61e7ea7)
		{
			/#
...
{
	if(level.round_number === 10 && !namespace_c3287616::function_fab464c4())
	{
