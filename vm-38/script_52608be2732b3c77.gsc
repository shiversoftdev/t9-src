...
*/
function private autoexec function_69a2c057()
{
	level notify(1118417538);
}
...
function function_1b3fc8e4()
{
	...
	self.maxhealth = self.maxhealth + (250000 + (100000 * getplayers().size)) + (level.doa.var_6c58d51 * 300000);
