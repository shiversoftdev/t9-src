...
*/
function private autoexec function_a664bea5()
{
	level notify(922138323);
}
...
function function_f79866a1(entity, mocompanim, mocompanimblendouttime, mocompanimflag, mocompduration)
{
	...
	{
		var_1b0f41cd = (isdefined(self.var_6c5c29fb) ? self.var_6c5c29fb : mocompduration.enemy.origin);
...
function private function_c0c49b7f(entity)
{
	...
	if(!is_true(entity.var_d4da163b) && !is_true(traced))
	{
		...
		if(var_cb67bd59 > sqr(var_97d0d061))
		{
			...
			trace = physicstrace(entity.origin + z_offset, (entity.origin + z_offset) + (var_a95ca3fd * sqrt(var_cb67bd59)), (0, 0, 0), (0, 0, 0), entity);
			if(trace[#"fraction"] !== 1)
			{
				var_a95ca3fd = (0, 0, 0);
			}
	...
	var_47a5b3d2 = (entity.var_faf3d7c1 + entity.var_efe6f3a3) * delta_time;
