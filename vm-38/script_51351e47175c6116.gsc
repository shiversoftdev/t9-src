...
#namespace namespace_bd104973;

/*
	Name: function_57b48b90
	Namespace: namespace_bd104973
	Checksum: 0x13E0189B
	Offset: 0x1E8
	Size: 0x14
...
*/
function private autoexec function_57b48b90()
{
	level notify(1105796196);
}
		...
		else
		{
			...
			else
			{
				...
				else
				{
					if(roll > 85)
					{
						doa_pickups::function_ad7ac41b(origin, 1, 32, 46, 1);
					}
					else
					{
						if(roll > 80)
