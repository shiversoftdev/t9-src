...
function function_70a657d8()
{
	...
	clientfield::register("toplayer", "mimic_attack_hit", 1, 1, "int", &function_36e6e4c4, 0, 0);
...
/*
	...
	Flags: Linked
*/
function function_36e6e4c4(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	if(bwastimejump)
	{
...
function function_1c6775d4(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	else
	{
		...
		playfx(fieldname, #"hash_16d245700e1be792", self.origin);
	}
}
