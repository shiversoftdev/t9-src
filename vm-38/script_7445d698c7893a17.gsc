...
*/
function private autoexec function_fd11519f()
{
	level notify(177002139);
}
...
function function_9384b521()
{
	...
	aat::register("ammomod_brainrot", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
	aat::register("ammomod_brainrot_1", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
	aat::register("ammomod_brainrot_2", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
	aat::register("ammomod_brainrot_3", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
	aat::register("ammomod_brainrot_4", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
	aat::register("ammomod_brainrot_5", 0.15, 0, 55, 5, 0, &result, "t7_hud_zm_aat_turned", "wpn_aat_turned_plr", &function_6f735de0, #"hash_16b5c37d8feae38c", undefined, #"hash_284e1e340e2541f0");
