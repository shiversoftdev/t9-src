...
{
	system::register(#"hash_145b120e873ea191", &function_70a657d8, undefined, undefined, #"load");
}
...
function function_542725a1()
{
	...
	if(!level.enable_magic || !is_true(namespace_59ff1d6c::function_901b751c(#"hash_3d18f84f48bd5d1f")))
	{
		return;
	}
