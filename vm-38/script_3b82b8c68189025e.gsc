...
*/
function private autoexec function_be1d6d84()
{
	level notify(-1121759039);
}
...
/*
	...
	Flags: Linked
*/
function function_82b16606(enter_func, exit_func, allow_movement, allow_weapon, script_bundle, var_4d84ed71, timeout, skippable)
{
...
function run(ai_actor, anim_struct, timer, activator, var_5bab29d8, var_cf6d95c9, var_5738c83e)
{
	...
	while(!var_6728c4b3)
	{
		...
		if(isdefined(var_b7751c0b.var_3fa65bba))
		{
			...
			ai_actor childthread function_a7575efe(var_b7751c0b.var_3fa65bba, var_b7751c0b.var_d3d10c6d, var_b7751c0b.skip_func);
		}
