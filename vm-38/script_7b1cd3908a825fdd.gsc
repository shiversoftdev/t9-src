...
*/
function private autoexec function_645a8fef()
{
	level notify(22714135);
}
...
function function_c70a47c(var_3ec7083c)
{
	...
	level flag::wait_till_any(array(#"hash_81da36e4389f10a", #"hash_2c83e17b76817284"));
	...
	{
		var_6d85de92 = arraycombine(getentitiesinradius(var_3ec7083c.origin, 512, 12), getentitiesinradius(var_3ec7083c.origin, 512, 14));
...
function private function_2b530a78()
{
	...
	wait(3);
	level.var_31028c5d prototype_hud::function_953da284(self, #"hash_1ea76eb37bb646db");
}

/*
	Name: function_aee71618
	Namespace: namespace_591b4396
	Checksum: 0xF141A43B
	Offset: 0x1170
	Size: 0x114
...
{
	level endon(#"hash_2c83e17b76817284");
	wait(1.5);
...
function function_839b3d5a(var_48236d2c)
{
	...
	else
	{
		...
		var_69c8822d = var_48236d2c.parent.var_fe2612fe[#"hash_5819d8571ea7c838"][0];
	...
	while(!level flag::get(#"hash_2c83e17b76817284") || !level flag::get(#"hash_fdc24944f59c262"))
	{
		...
		if(is_true(self.var_2c27f919) || (!self.v_train_inbound_igc && self function_591cb2f4(t_exfil)))
		{
			...
			if(!level flag::get(#"hash_2c83e17b76817284"))
			{
				if(zm_utility::is_classic())
				{
					level.var_31028c5d prototype_hud::function_953da284(self, #"hash_1530af61f721d3e7");
				}
				else
				{
					level.var_31028c5d prototype_hud::function_953da284(self, #"hash_18a40982c5569db2");
				}
			}
...
{
	level endon(#"hash_69090774fec4a17b", #"hash_158779eefe4893d1", #"hash_4fbe4720f6f13107", #"end_game", #"hash_2c83e17b76817284");
	if(var_3aeede0b >= 30)
	{
...
function function_c504b2d1()
{
	...
	b_success = 0;
	if(level flag::get(#"hash_2c83e17b76817284") && level flag::get(#"hash_fdc24944f59c262"))
	{
		b_success = 1;
	}
	level notify(#"hash_4fbe4720f6f13107", {#b_success:b_success});
...
function function_31125f54()
{
		...
		else
		{
			...
			else
			{
				...
				foreach(s_scene in a_s_scenes)
				{
					...
					if(isdefined(str_scene) && isinarray(array(#"hash_5505d04b48e43a18"), str_scene))
					{
	...
	else
	{
		...
		{
			if(!isdefined(level.var_fdcaf3a6.target2))
			{
				str_scene = #"hash_50ba0a10051780b3";
				s_scene = spawnstruct();
				s_scene.origin = level.var_117d5f10.origin;
				s_scene.angles = level.var_117d5f10.angles;
				s_scene scene::play(str_scene, level.var_117d5f10);
			...
			else
			{
				...
				{
					str_scene = hash(s_scene.scriptbundlename);
					if(isdefined(str_scene) && isinarray(array(#"hash_50ba0a10051780b3"), str_scene))
					{
	...
	objective_manager::function_2c679cc2(level.var_fdcaf3a6, b_success);
}
...
function function_5ddbfe57(var_68cc0f1f)
{
	...
	while(!level flag::get(#"hash_2c83e17b76817284"))
	{
		s_result = undefined;
...
{
	self notify("48b0b0228d068b67");
	self endon("48b0b0228d068b67");
	self endon(#"death");
	level endon(#"hash_2c83e17b76817284");
	var_5789be51 = 1024;
	var_4c93765a = 512;
	...
	if(zm_utility::is_classic())
	{
		...
		else
		{
			...
			var_f67d1ba2 = generatenavmeshpath(self.origin, s_smoke.origin, undefined, self getpathfindingradius(), self function_6a9ae71());
			if(var_f67d1ba2.status === "succeeded")
			{
				a_v_points = arraysortclosest(var_f67d1ba2.pathpoints, self.origin, undefined, 500, 1000);
	...
	n_ai_count = 0;
	i = 0;
	str_bundle = "exfil_per_player_realm_" + level.var_15d17eb2;
...
function function_9feae843(var_fda8dff8)
{
	...
	str_bundle = "exfil_realm_" + level.var_15d17eb2;
	...
	var_9cc58c14 = (level.var_15d17eb2 !== 4 ? 0 : 1);
	i = 0;
...
function function_5dd89100()
{
	...
	{
		s_smoke = level.var_fdcaf3a6.var_fe2612fe[#"hash_216188a7e7b381a6"][0];
	}
	v_loc = s_smoke.origin;
	v_angles = s_smoke.angles;
	level fx::play(#"hash_7789ba1857e7bd0a", v_loc, v_angles, #"hash_2c83e17b76817284");
}

/*
	Name: function_b5019d74
	Namespace: namespace_591b4396
	Checksum: 0xF14500D1
	Offset: 0x7378
	Size: 0xDC
...
function function_b5019d74()
{
	...
	v_angles = s_smoke.angles;
	level flag::wait_till(#"exfil_heli_arrived");
	level fx::play(#"hash_1ebbe325fb97bb3", v_loc, v_angles, #"hash_2c83e17b76817284");
}
...
function private function_3a488e53(b_show, n_remaining)
{
	...
	if(b_show)
	{
		if(!level.var_fdcaf3a6.var_1961f29a luielemcounter::is_open(self))
		{
			...
			level.var_fdcaf3a6.var_1961f29a luielemcounter::function_2208b8db(self, 1);
			level.var_fdcaf3a6.var_1961f29a luielemcounter::function_7420df0a(self, 1);
			level.var_fdcaf3a6.var_1961f29a luielemcounter::function_eccc151d(self, 1);
			level.var_fdcaf3a6.var_1961f29a luielemcounter::function_aa5c711d(self, 0.75);
			level.var_fdcaf3a6.var_1961f29a luielemcounter::function_1bd2bb26(self, 1);
		}
		else
		{
			level.var_fdcaf3a6.var_1961f29a luielemcounter::set_number(self, n_remaining);
	...
	else if(level.var_fdcaf3a6.var_1961f29a luielemcounter::is_open(self))
	{
		if(n_remaining === 0)
		{
			level.var_fdcaf3a6.var_1961f29a util::delay(3, undefined, &luielemcounter::close, self);
...
/*
	...
	Flags: Linked, Private
*/
function private function_189f87c1()
{
