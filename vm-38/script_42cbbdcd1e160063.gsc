...
*/
function private autoexec function_4cd409c6()
{
	level notify(432907419);
}
...
function function_d0edb8b6(localclientnum, name, tag, unique)
{
	...
	{
		self.fxorigin thread function_f58618d7(localclientnum, name, 0, tag, unique);
	}
	else
	{
		self thread function_f58618d7(localclientnum, name, 0, tag, unique);
	}
}

/*
	Name: function_e76f738
	Namespace: namespace_83eb6304
	Checksum: 0x85103194
	Offset: 0x34A0
	Size: 0x16C
	...
	Flags: Linked
*/
function function_e76f738(localclientnum, name, tag, unique, var_1fbeccf)
{
	if(!isdefined(var_1fbeccf))
	{
		var_1fbeccf = 0;
	}
	if(var_1fbeccf)
