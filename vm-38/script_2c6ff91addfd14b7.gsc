...
*/
function private autoexec function_21295656()
{
	level notify(919315870);
}
...
function function_ded83def(lastenemy)
{
	if(isdefined(self.enemy) && isplayer(self.enemy))
	{
		...
		{
			if(lastdisttoenemysquared > sqr(250) && !is_true(self.servershortout) && isdefined(self.sndalias[#"hash_6dacc5a8faf1b6f3"]))
			{
		...
		else
		{
			...
			{
				if(lastdisttoenemysquared > sqr(750) && !is_true(self.servershortout) && isdefined(self.sndalias[#"hash_26569720e0ae76f3"]))
				{
			...
			{
				if(lastdisttoenemysquared > sqr(1500) && !is_true(self.servershortout) && isdefined(self.sndalias[#"hash_22b0b71c07ac7fea"]))
				{
