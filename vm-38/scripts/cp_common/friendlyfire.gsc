...
*/
function private autoexec function_d16c7a7c()
{
	level notify(1181270885);
}
...
/*
	...
	Flags: Linked
*/
function friendly_fire_callback(entity, damage, attacker, method, weapon, einflictor)
{
	if(!isdefined(entity))
	{
		return;
	...
	if(weapon.name === #"eq_flash_grenade" || weapon.name === #"hash_675e85b293a65c14")
	{
		return;
	}
