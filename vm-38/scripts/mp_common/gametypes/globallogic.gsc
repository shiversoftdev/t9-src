...
*/
function private autoexec function_db03b8ee()
{
	level notify(-1961551186);
}
...
{
	level.var_1766510 = 1;
	self notify("6ba8ad20b2ae17e3");
	self endon("6ba8ad20b2ae17e3");
	level endon(#"game_ended");
...
function private function_e4335431()
{
	...
	foreach(stash in level.item_spawn_stashes)
	{
		...
		data = {#hash_fa0ba6bc:is_true(stash.lootlocker), #hash_a7feba9c:(isdefined(stash.var_80b1d504) ? stash.var_80b1d504 : 0), #state:state, #used:state != 0, #type:stash.var_15d44120, #pos_z:stash.origin[2], #pos_y:stash.origin[1], #pos_x:stash.origin[0]};
...
function function_2960a822(activeteamcount)
{
	...
	{
		if(level.teambased && !getdvarint(#"hash_28d42b90a5f80361", 0))
		{
...
{
	self notify("2b96c36bfbaabfa2");
	self endon("2b96c36bfbaabfa2");
