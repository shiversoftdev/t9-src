...
*/
function private autoexec function_bf3877ad()
{
	level notify(1095667661);
}
...
function private function_70a657d8()
{
	...
	clientfield::function_a8bbc967("PositionDraft.stage", #"hash_6797d4cd7534952f", #"stage", 1, 4, "int", undefined, 0, 0);
	clientfield::function_a8bbc967("PositionDraft.autoSelected", #"hash_6797d4cd7534952f", #"autoselected", 1, 1, "int", undefined, 0, 0);
	clientfield::function_a8bbc967("PositionDraft.cooldown", #"hash_6797d4cd7534952f", #"cooldown", 1, 5, "int", undefined, 0, 0);
	...
	level.var_f7fb38f8 = [];
	level.var_f7fb38f8[#"none"] = #"draft_team_struct";
...
{
	if(masked && !(is_true([[ var_d0c67621 ]]->function_82e05d64().masked)))
	{
		[[ var_d0c67621 ]]->function_27945cb8(1);
		[[ var_d0c67621 ]]->function_82e05d64().masked = 1;
	}
	else if(!masked && is_true([[ var_d0c67621 ]]->function_82e05d64().masked))
	{
	...
	for(i = 0; i < 5; i++)
	{
		...
		if(isdefined(positiondraftclientsmodel))
		{
			...
			if(clientnum >= 0)
			{
				...
				if(is_true([[ var_d0c67621 ]]->function_82e05d64().islocalclient) || codcaster::function_b8fe9b52(localclientnum))
				{
					...
					if(isdefined([[ var_d0c67621 ]]->function_82e05d64().var_c018da16) && player_role::is_valid([[ var_d0c67621 ]]->function_82e05d64().var_c018da16.charactertype) || codcaster::function_b8fe9b52(localclientnum))
					{
				...
				if(codcaster::function_b8fe9b52(localclientnum) && !(isdefined([[ var_d0c67621 ]]->function_82e05d64().var_91065a59)) && isdefined(player) && isbot(player))
				{
