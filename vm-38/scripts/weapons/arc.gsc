...
*/
function private autoexec function_1e9c2b0()
{
	level notify(1361765334);
}
...
/*
	...
	Flags: None
*/
function find_arc_targets(var_26b2b1bb, eattacker, arc_source, arc_source_origin, depth, var_4d3cc1a7)
{
	if(!isdefined(var_4d3cc1a7))
	{
		var_4d3cc1a7 = 1;
