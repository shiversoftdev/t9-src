...
function function_9b9cecdf()
{
	...
	clientfield::register_clientuimodel("hudItems.playerLivesRemaining", #"hud_items", #"hash_6dddb9a20d49665d", 7000, 4, "int", undefined, 0, 0);
	clientfield::register_clientuimodel("hudItems.playerCanRedeploy", #"hud_items", #"hash_116a728dee230334", 7000, 1, "int", undefined, 0, 0);
