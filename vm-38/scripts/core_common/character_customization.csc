...
class class_7da27482 
{
	...
	*/
	function function_9b661089(params)
	{
		...
		{
			var_b0324f12 = function_aa09bdbb(_xuid);
			...
			{
				self.var_e09268b7 = util::spawn_anim_model(var_f141235b, var_7668a4b7, _origin, _angles);
	...
	*/
	function function_dd872e2b(params, force_updates)
	{
		...
		else if(isdefined(params.activeweapon))
		{
			...
			if(isdefined(_xuid))
			{
				notify_event = "update_character_weapons_" + _xuid;
			}
