...
*/
function private autoexec function_6788d675()
{
	level notify(-403443562);
}
...
function private function_4c0124cd()
{
	/#
		...
		record3dtext("" + function_9e72a96(var_99dffb44), self.origin, factioncolor, "", self);
		record3dtext((function_9e72a96(self.team) + "") + function_9e72a96(var_501b8f06), self.origin, factioncolor, "", self);
	#/
}
