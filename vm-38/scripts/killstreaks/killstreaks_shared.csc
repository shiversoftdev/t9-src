...
*/
function private autoexec function_767487e1()
{
	level notify(-968254399);
}
...
{
	clientfield::register_clientuimodel("locSel.commandMode", #"hash_5bbe0cd6740ab2b6", #"hash_59184771800cc1f9", 1, 1, "int", undefined, 0, 0);
	clientfield::register_clientuimodel("locSel.snapTo", #"hash_5bbe0cd6740ab2b6", #"hash_4f706dc5af7c4cec", 1, 1, "int", undefined, 0, 0);
