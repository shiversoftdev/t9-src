...
*/
function private autoexec function_8e8308dc()
{
	level notify(837638801);
}
...
function private function_70a657d8()
{
	...
	clientfield::function_a8bbc967("hudItems.armorPercent", 1, 7, "float", 0);
	clientfield::function_a8bbc967("hudItems.scrap", 1, 16, "int", 0);
	clientfield::function_a8bbc967("hudItems.rareScrap", 1, 16, "int", 0);
	clientfield::function_a8bbc967("pap_current", 1, 2, "int", 0);
...
function is_classic()
{
	...
	{
		level.var_8d156cf3 = util::function_5df4294() == #"zclassic" || util::function_5df4294() == #"hash_1f847b868c4199a3";
	}
...
function is_survival()
{
	...
	{
		level.var_50d2a17f = util::function_5df4294() == #"zsurvival";
	}
...
function function_c200446c()
{
	...
	{
		level.var_e9ff2970 = util::function_5df4294() == #"zonslaught" || is_true(level.var_ce3ac5b6);
	}
...
function is_standard()
{
	...
	{
		level.var_9bd33c61 = util::function_5df4294() == #"zstandard";
	}
...
function is_trials()
{
	...
	{
		level.var_bc0dd8f3 = util::function_5df4294() == #"hash_32a608b582834498";
	}
...
function is_tutorial()
{
	...
	{
		level.var_f9cd414c = util::function_5df4294() == #"ztutorial";
	}
...
function is_grief()
{
	...
	{
		level.var_80b0bb3d = util::function_5df4294() == #"zgrief";
	}
...
function function_c4b020f8()
{
	...
	{
		level.var_7ef56397 = util::function_5df4294() == #"hash_339838bfa1eb964d";
	}
	return level.var_7ef56397;
}

/*
	Name: function_6931bc89
	Namespace: zm_utility
	Checksum: 0xEC49871F
	Offset: 0x10B8
	Size: 0x4A
...
function function_6931bc89()
{
	...
	{
		level.var_2abedddf = util::function_5df4294() == #"doa";
	}
...
{
	if(getnumexpectedplayers() == 1 && (!sessionmodeisonlinegame() || sessionmodeisprivate() || zm_trial::function_b47f6aba() || getdvarint(#"com_maxclients", 0) == 1))
	{
...
function function_c52e1749(origin, players)
{
	...
	{
		self.var_c6e0686b = sqr(var_f67d1ba2.pathdistance);
	}
...
function get_closest_valid_player(origin, ignore_player, var_b106b254)
{
	...
	if(!isdefined(player.last_valid_position) || (!is_true(level.var_9f01688e) && !is_true(player.cached_zone_volume.var_8e4005b6)) || !isdefined(player getgroundent()) || ((isdefined(self.var_737e8510) ? self.var_737e8510 : level.var_376e688)))
	{
		...
		{
			namespace_e0710ee6::function_4d22f6d1(self);
		}
	}
	else
	{
...
{
	self notify("570f11ed86bc7592");
	self endon("570f11ed86bc7592");
	self endon(#"death");
...
/*
	...
	Flags: Linked
*/
function can_use(e_player, var_ea5d26bb, var_67fee570)
{
	if(!isdefined(var_ea5d26bb))
	{
		var_ea5d26bb = 0;
	}
	if(!isdefined(var_67fee570))
...
function give_achievement(achievement, all_players)
{
	...
	/#
		assert(function_7a600918(achievement), "");
	#/
	if(all_players)
	{
...
/*
	...
	Flags: Linked
*/
function function_e0448fec(var_54cb21f6)
{
...
{
	self notify("35e8b22801bc7b76");
	self endon("35e8b22801bc7b76");
...
function function_4a25b584(v_start_pos, var_487ba56d, n_radius, b_randomize, var_79ced64, n_half_height, var_21aae2c6, var_a5b5d950)
{
	...
	for(i = 0; i < var_487ba56d; i++)
	{
		...
		{
			var_7d81025 setmodel(var_a5b5d950);
		}
	...
	else
	{
		if(function_c200446c())
		{
			...
			else
			{
				...
				{
					if(var_cf03ccb6 > 5 && var_cf03ccb6 <= 7)
					{
						var_3afe334f = 5;
					}
					else if(var_cf03ccb6 > 7)
					{
						var_3afe334f = 6;
					}
				}
...
function get_round_number(var_ec585b8)
{
	...
	if(is_survival())
	{
		...
		{
			if((level.var_b48509f9 - 1) >= var_88710b09.size)
			{
...
function private function_e1a11b1(var_8861fa85, n_radius, trigger, var_ab426dbb)
{
	...
	self notify("5965a847cc1b5398");
	self endon("5965a847cc1b5398");
...
function function_60daf5f7(str_name, str_key, b_hide)
{
	...
	var_b8055433 = getent(str_name, str_key);
	if(isdefined(var_b8055433))
	{
		if(b_hide)
		{
			if(isdefined(var_b8055433.objectiveid))
			{
				function_e8f4d47b(getplayers(), var_b8055433.objectiveid, 1);
				objective_setinvisibletoall(var_b8055433.objectiveid);
			}
			var_b8055433.trigger hide();
			var_b8055433 hide();
			var_b8055433 notsolid();
		}
		else
		{
			var_b8055433.trigger show();
			var_b8055433 show();
			var_b8055433 solid();
			if(isdefined(var_b8055433.objectiveid))
			{
				objective_setvisibletoall(var_b8055433.objectiveid);
				function_e8f4d47b(getplayers(), var_b8055433.objectiveid, 0);
			}
		}
	}
}
...
/*
	...
	Flags: Linked
*/
function function_ca960904(var_b8055433, var_cc253f86, var_6f0e765d)
{
	...
	if(!isinarray(level.var_c427e93b, var_b8055433))
	{
		level.var_c427e93b[level.var_c427e93b.size] = var_b8055433;
	}
	var_b8055433 clientfield::set("force_stream", 1);
	var_b8055433.var_cc253f86 = var_cc253f86;
	var_b8055433.var_6f0e765d = var_6f0e765d;
}
...
/*
	...
	Flags: Linked
*/
function function_d729de6a(b_enable, a_str_zones)
{
	if(!isdefined(b_enable))
	{
		b_enable = 1;
...
{
	self notify("555ed8decd74422d");
	self endon("555ed8decd74422d");
	...
	while(true)
	{
		...
		var_be17187b = undefined;
		var_be17187b = self waittill(#"hash_2d4daa9e80b86b60", #"hash_35db0208f90f5145");
	}
...
{
	if(self.team === level.zombie_team && isplayer(params.eattacker) && params.eattacker flag::get(#"hash_35db0208f90f5145"))
	{
...
/*
	...
	Flags: Linked
*/
function function_cf7a0b3d(var_81aa5a36, a_str_zones)
{
	if(!isdefined(var_81aa5a36))
	{
		var_81aa5a36 = 1;
	}
	foreach(str_zone in a_str_zones)
...
/*
	...
	Flags: Linked
*/
function function_c2da57a7(var_ac0be832, a_str_zones)
{
	if(!isdefined(var_ac0be832))
	{
		var_ac0be832 = 1;
	}
	foreach(str_zone in a_str_zones)
...
{
	mdl_machine playrumbleonentity(#"hash_78941b392fc1e666");
	a_vehicles = [];
