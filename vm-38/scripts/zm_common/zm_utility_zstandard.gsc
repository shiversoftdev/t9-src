...
/*
	...
	Flags: None
*/
function open_door(a_str_door_names, var_47eb646a, var_91ccb2d7, b_play_audio)
{
...
/*
	...
	Flags: None
*/
function drop_key(v_start_pos, var_b545186e)
{
...
/*
	...
	Flags: None
*/
function function_11101458(var_f79ff5ec, var_6cc77d4e, hide_notify)
{
	if(!isdefined(var_6cc77d4e))
	{
		var_6cc77d4e = #"hash_3a35084ee8c333b2";
	}
	if(!isdefined(hide_notify))
	{
		hide_notify = "creating_zone_defend_area";
	}
...
function function_428cfaae(var_679cd7a8, var_6cc77d4e, hide_notify, n_obj_id, var_e1feb2f6)
{
	...
	self thread zm_equipment::show_hint_text(hide_notify.var_16a34df0, 10, 1.75, 120);
	while(true)
	{
		if(self [[hide_notify.var_9fc5eea1]]())
		{
...
function function_33798535(var_31721422, a_str_zones, var_ed1db1a7, var_6cc77d4e, var_de0f1997, var_f7c3c527, var_232e4ebc, var_b96be97f)
{
	...
	if(level flag::exists(#"disable_fast_travel") && !is_true(level.var_81c681aa))
	{
...
function enable_power_switch(b_enable, var_909e9d3d, str_value, str_key, var_34451c07)
{
	...
	if(b_enable)
	{
		...
		foreach(t_power in a_t_power)
		{
			...
			if(var_909e9d3d)
			{
				player = arraygetclosest(t_power.origin, function_a1ef346b());
