...
*/
function private autoexec function_e3711f44()
{
	level notify(433784703);
}
		...
		do
		{
			...
			foreach(zone_name in var_1534e9b7)
			{
				...
				foreach(flag in zone.flags)
				{
					if(flag === flag_name)
					{
						array::push_front(var_14a2a339, zone_name);
					}
				}
			}
			if(var_14a2a339.size > 0)
			{
				var_34eb3246 = array::pop_front(var_14a2a339);
