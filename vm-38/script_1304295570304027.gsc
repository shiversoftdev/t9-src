...
*/
function private autoexec function_2e664129()
{
	level notify(345335710);
}
...
function credit_player(player, string, var_24672ed6, var_81b74b24, neutralizing, time, var_a84f97bf, var_af8f6146)
{
	...
	if(!is_score_boosting(player, self))
	{
		...
		if(var_af8f6146)
		{
			...
			player contracts::function_a54e2068(#"hash_4707e1fca6bc2a94");
		}
	}
	else
	{
...
{
	self notify("306f73f1a3ac783c");
	self endon("306f73f1a3ac783c");
