...
{
	system::register(#"hash_206e095d8825190d", &function_70a657d8, undefined, undefined, #"hash_2d064899850813e2");
}
...
function function_dfd10619()
{
	...
	else
	{
		...
		self notify(#"hash_5c0553bb6c8d08d1");
	}
}
...
function private function_3c87c880()
{
	...
	var_be17187b = self waittill(#"hash_57d4f53c12705eac", #"player_revived");
