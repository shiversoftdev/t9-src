...
*/
function private autoexec function_d2bbff2()
{
	level notify(1996428351);
}
...
{
	self notify("4e97e4cc1fa187a1");
	self endon("4e97e4cc1fa187a1");
...
{
	self notify("5e67c2789da7ab6b");
	self endon("5e67c2789da7ab6b");
	level endon(#"game_over");
...
{
	self notify("7f19890f23404f8");
	self endon("7f19890f23404f8");
