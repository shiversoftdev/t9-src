...
*/
function private autoexec function_9b8d00d8()
{
	level notify(907662561);
}
...
function start_vortex(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	vortex_fx_handle = playfx(binitialsnap, registerplayer_lift_clipbamfupdate, var_3d2b5c8c);
	setfxignorepause(binitialsnap, vortex_fx_handle, 1);
	audio::playloopat("evt_doa_pickup_vortex_active_lp", var_3d2b5c8c);
	self thread vortex_shake_and_rumble(binitialsnap, var_3d2b5c8c);
	self thread function_2dd3c5bc(binitialsnap, vortex_fx_handle, var_3d2b5c8c, var_800bc32d, n_vortex_time);
}
...
function function_2dd3c5bc(localclientnum, vortex_fx_handle, var_3d2b5c8c, var_800bc32d, n_vortex_time)
{
	...
	audio::stoploopat("evt_doa_pickup_vortex_active_lp", var_3d2b5c8c);
	wait(0.15);
