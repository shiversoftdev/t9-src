...
*/
function private autoexec function_14e9da53()
{
	level notify(1317771422);
}
...
{
	self notify("6c7b7585a18b4758");
	self endon("6c7b7585a18b4758");
	while(true)
	{
...
{
	self notify("538c8a3ff7408ec8");
	self endon("538c8a3ff7408ec8");
	self endon(#"death");
...
function function_d138afd9()
{
	...
	{
		if(isinarray(self.var_d1fac34a.var_2b5ed682, self))
		{
			arrayremovevalue(self.var_d1fac34a.var_2b5ed682, self);
		}
...
/*
	...
	Flags: None
*/
function function_db744d28(var_370ac26d)
{
	if(!isdefined(var_370ac26d))
	{
		var_370ac26d = getdvarint(#"hash_4321f22c262c3ad1", 300);
	}
	self.boss = 1;
...
/*
	...
	Flags: None
*/
function function_39451598(var_370ac26d)
{
	if(!isdefined(var_370ac26d))
	{
		var_370ac26d = getdvarint(#"hash_4321f22c262c3ad1", 300);
	...
	self endon(#"death");
	self notify("50ffa517d252eb9f");
	self endon("50ffa517d252eb9f");
...
{
	self notify("1c3bf0d934d731f9");
	self endon("1c3bf0d934d731f9");
	self endon(#"death");
	if(isvehicle(self))
	{
		return;
