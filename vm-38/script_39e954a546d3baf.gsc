...
#namespace namespace_5b224bb0;

/*
	Name: function_1843fbda
	Namespace: namespace_5b224bb0
	Checksum: 0x3BF74461
	Offset: 0x308
	Size: 0x14
...
*/
function private autoexec function_1843fbda()
{
	level notify(1616035386);
}
...
/*
	...
	Flags: None
*/
function open_door(var_68454baa, var_47eb646a, var_91ccb2d7, b_play_audio)
{
	if(!isdefined(var_47eb646a))
	{
		var_47eb646a = 0;
	}
	if(!isdefined(b_play_audio))
	{
		b_play_audio = 0;
	}
...
/*
	...
	Flags: None
*/
function function_26a5066b(n_round_number, var_232e4ebc)
{
	if(!isdefined(var_232e4ebc))
	{
		var_232e4ebc = 1;
	}
	...
	if(isdefined(level.var_26a5066b[n_round_number]) && !is_true(level.var_26a5066b[n_round_number].var_6faa5e34) && isdefined(level.var_26a5066b[n_round_number].var_232e4ebc))
	{
...
function function_31e9c9c6(n_round_number)
{
	...
	if(isdefined(level.var_26a5066b[n_round_number]) && !is_true(level.var_26a5066b[n_round_number].var_6faa5e34))
	{
...
/*
	...
	Flags: None
*/
function function_6df718d(var_d147b93a, var_5cd8902e, var_70516a9d)
{
	if(!isdefined(var_5cd8902e))
	{
		var_5cd8902e = 0;
	}
	if(!isdefined(var_70516a9d))
	{
		var_70516a9d = &function_9dc9326c;
	}
...
/*
	...
	Flags: None
*/
function function_511ee23e(var_35200797)
{
	if(!isdefined(var_35200797))
	{
		var_35200797 = 1;
	}
...
/*
	...
	Flags: None
*/
function function_27b4c2be(var_35200797)
{
	if(!isdefined(var_35200797))
	{
		var_35200797 = 1;
...
/*
	...
	Flags: None
*/
function function_214563e(var_35200797, stop_time_travel_on_)
{
	if(!isdefined(var_35200797))
	{
		var_35200797 = 1;
	...
	if(!is_true(self.ignore_enemy_count) && a_ai_zombies.size == 1 && level.zombie_total <= 0 && !level flag::get("infinite_round_spawning"))
	{
		...
		foreach(s_key in level.var_26a5066b)
		{
			...
			if(var_b30c192b <= var_f1e10d43 || n_chance < level.var_4ffadb4c)
			{
				...
				if(!var_ebcac3c2 && (is_true(self.var_c39323b5) || (!(check_point_in_playable_area(v_start) && check_point_in_enabled_zone(v_start))) || is_true(self.nuked)))
				{
					e_player = arraygetclosest(v_start, function_a1ef346b());
...
/*
	...
	Flags: None
*/
function function_aad01548(v_start_pos, var_b545186e)
{
	if(!isdefined(var_b545186e))
	{
		var_b545186e = 0;
	}
	...
	if(var_b545186e)
	{
		e_player = arraygetclosest(v_start_pos, function_a1ef346b());
...
/*
	...
	Flags: None
*/
function function_40ef77ab(var_573c22c3, b_random)
{
...
/*
	...
	Flags: None
*/
function function_defc6586(var_3d15828d, b_random)
{
	if(!isdefined(b_random))
	{
		b_random = 1;
...
/*
	...
	Flags: None
*/
function function_11101458(var_f79ff5ec, var_6cc77d4e, var_9c19b511)
{
	if(!isdefined(var_6cc77d4e))
	{
		var_6cc77d4e = #"hash_3a35084ee8c333b2";
	}
	if(!isdefined(var_9c19b511))
	{
		var_9c19b511 = "creating_zone_defend_area";
	}
...
function function_428cfaae(var_679cd7a8, var_6cc77d4e, var_9c19b511, n_obj_id, var_e1feb2f6)
{
	...
	self thread zm_equipment::show_hint_text(var_9c19b511.var_16a34df0, 10, 1.75, 120);
	while(true)
	{
		if(self [[var_9c19b511.var_9fc5eea1]]())
		{
...
/*
	...
	Flags: None
*/
function function_76321cf4(b_enable)
{
...
/*
	...
	Flags: None
*/
function function_33798535(var_31721422, a_str_zones, var_ed1db1a7, var_6cc77d4e, var_de0f1997, var_f7c3c527, var_232e4ebc, var_b96be97f)
{
	if(!isdefined(var_6cc77d4e))
	{
		var_6cc77d4e = #"hash_683cf7d37afcc3ae";
	}
	if(!isdefined(var_de0f1997))
	{
		var_de0f1997 = 45;
	}
	if(!isdefined(var_f7c3c527))
	{
		var_f7c3c527 = 60;
	}
	if(!isdefined(var_232e4ebc))
	...
	function_9757d4d2(1);
	callback::on_ai_damage(&function_cff5da11);
	callback::on_ai_killed(&function_d40910b4);
	if(level flag::exists(#"hash_1b9ecc7979b0fcfb") && !is_true(level.var_81c681aa))
	{
	...
	while(var_de0f1997 >= 0)
	{
		...
		if(b_any_player_in_zone && n_time_elapsed >= 5)
		{
			...
			switch(var_d2f964c9)
			{
				case 1:
				{
					var_959457a1 = function_a1ef346b().size * 1;
					break;
				}
				case 2:
				{
					var_959457a1 = function_a1ef346b().size * 1.5;
					break;
				}
				case 3:
				{
					var_959457a1 = function_a1ef346b().size * 1.75;
					break;
				}
				case 4:
				{
		...
		if(b_any_player_in_zone && var_de0f1997 < 10 && !is_true(level.var_54f329be))
		{
			function_9757d4d2(1);
...
function function_d40910b4(params)
{
	...
	if(!is_true(self.ignore_enemy_count) && a_ai_zombies.size == 1 && level.zombie_total <= 0 && !level flag::get("infinite_round_spawning"))
	{
		...
		if(is_true(self.var_c39323b5) || (!(check_point_in_playable_area(v_start) && check_point_in_enabled_zone(v_start))) || is_true(self.nuked))
		{
...
function function_cff5da11(params)
{
	...
	if(isplayer(params.eattacker) && var_7fcc8528 == a_ai_enemies.size)
	{
...
function function_766eff6(var_31721422, a_str_zones, var_de0f1997, var_f7c3c527)
{
		...
		else
		{
			foreach(player in function_a1ef346b())
			{
				if(isalive(player) && player zm_zonemgr::is_player_in_zone(a_str_zones))
				{
					...
					if(!is_true(player.var_fd3dfced))
					{
				...
				if(isalive(player) && !player zm_zonemgr::is_player_in_zone(a_str_zones) && is_true(player.var_fd3dfced))
				{
	...
	while(var_f7c3c527 >= 0 || !is_true(level.var_e0b78e03))
	{
		if(self.var_fd3dfced)
		{
			var_dd433f03++;
		}
		if(var_f7c3c527 <= 0 && !is_true(level.var_a286b947))
		{
...
function player_left_zone(a_str_zones, var_8e2567b1, var_9faecc20)
{
	...
	while(true)
	{
		...
		while(true)
		{
			...
			if(n_time <= 0 || is_true(var_9faecc20) && !is_true(self.var_16735873))
			{
				if(level.var_f995ece6 zm_trial_timer::is_open(self))
				{
					level.var_f995ece6 zm_trial_timer::close(self);
...
/*
	...
	Flags: None
*/
function function_1aaa4f63(var_3534ec82, var_f24b3f7a)
{
	if(!isdefined(var_3534ec82))
	{
		var_3534ec82 = 1;
	}
	if(!isdefined(var_f24b3f7a))
	{
		var_f24b3f7a = 0;
	}
	level.var_e0b78e03 = undefined;
...
/*
	...
	Flags: None
*/
function function_9757d4d2(var_35105434)
{
	if(!isdefined(var_35105434))
	{
		var_35105434 = 0;
	}
...
/*
	...
	Flags: None
*/
function function_9b7bc715(str_archetype, var_f6e469ad)
{
	if(!isdefined(var_f6e469ad))
	{
		var_f6e469ad = 1;
	}
...
/*
	...
	Flags: None
*/
function function_6cb904e2(v_start_pos, var_487ba56d, n_radius, b_randomize, var_79ced64)
{
...
/*
	...
	Flags: None
*/
function function_92162963(var_b9fefaba, b_permanent)
{
...
/*
	...
	Flags: None
*/
function function_72725f77(b_permanent)
{
	if(!isdefined(b_permanent))
	{
		b_permanent = 0;
...
/*
	...
	Flags: None
*/
function enable_power_switch(b_enable, var_909e9d3d, str_value, str_key, var_34451c07)
{
	if(!isdefined(b_enable))
	{
		b_enable = 0;
	}
	if(!isdefined(var_909e9d3d))
	{
		var_909e9d3d = 0;
	}
	...
	if(b_enable)
	{
		...
		foreach(var_923d12da in var_3fde5055)
		{
			...
			if(var_909e9d3d)
			{
				player = arraygetclosest(var_923d12da.origin, function_a1ef346b());
