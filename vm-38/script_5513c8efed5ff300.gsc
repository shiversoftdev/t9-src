...
*/
function private autoexec function_110844ff()
{
	level notify(2110682348);
}
...
{
	return is_true(savegame::get_player_data(#"hash_2895afd5f948f51"));
}
