...
*/
function private autoexec function_4cbfc756()
{
	level notify(2090321478);
}
...
{
	self notify("174fce2b5874ebef");
	self endon("174fce2b5874ebef");
	level endon(#"game_ended");
	while(true)
	{
		players = getplayers();
...
{
	self notify("19c9fe71616cec67");
	self endon("19c9fe71616cec67");
	level endon(#"game_ended");
	while(true)
	{
		players = getplayers();
...
{
	self notify("54010ad46c1aa153");
	self endon("54010ad46c1aa153");
...
{
	self notify("440b7a091423d546");
	self endon("440b7a091423d546");
	self endon(#"death", #"entering_last_stand", #"hash_2781407e327b42ee");
	while(true)
	{
		waitframe(1);
...
function pickup_item(item, var_22be503, var_26a492bc, var_b362e309)
{
	...
	if(namespace_b376ff3f::function_7d5553ac() || item.var_a6762160.itemtype != #"weapon")
	{
		var_d72b1a4b = function_c8ab2022(item, 0);
		var_8cd447d8 = function_c8ab2022(item, 1);
