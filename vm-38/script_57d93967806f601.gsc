...
*/
function private autoexec function_cbd38daa()
{
	level notify(195277100);
}
...
function private function_3e9077b(localclientnum)
{
	...
	while(true)
	{
		...
		var_97248341 = getenemyplayers(localclientnum, self.team, self.origin, 21600 + 15);
		foreach(player in var_97248341)
		{
			waitframe(1);
			if(!isdefined(player))
			{
