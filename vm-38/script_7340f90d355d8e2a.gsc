...
{
	if(level.basegametype == #"fireteam_dirty_bomb" || level.basegametype == #"hash_2a8c6a2ad775902a" || level.basegametype == #"hash_b18026c96daae8b")
	{
		/#
