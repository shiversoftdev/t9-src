...
*/
function private autoexec function_a82c939b()
{
	level notify(562053796);
}
...
/*
	...
	Flags: Linked
*/
function spawn_helicopter(owner, origin, angles, var_87735872, target_offset, killstreakbundle, killstreak_id)
{
...
function heli_think(owner, startnode, heli_team, protectlocation, var_6b4047f4, armored, killstreak_id)
{
	...
	chopper thread namespace_14c38db0::function_7e1a12ce(killstreakbundle.var_2aeadfa0);
...
function function_d4896942()
{
	...
	chopper waittill(#"hash_63404ad70a51f8ca");
...
function heli_get_protect_spot(heli, protectdest, var_551cf1b9, heli_team, hardpointtype, var_c18556e5)
{
	...
	var_783ce12c = self.killstreakbundle.var_2e4c8245;
	var_c4124b8e = self.killstreakbundle.var_8c1406f;
	if(hardpointtype == #"axis")
	{
		var_783ce12c = var_783ce12c + self.killstreakbundle.var_d2c774e8;
		var_c4124b8e = var_c4124b8e + self.killstreakbundle.var_d2c774e8;
	}
...
function heli_protect(startnode, protectdest, hardpointtype, heli_team)
{
	...
	while(gettime() < self.killstreakendtime)
	{
		if(is_true(level.var_e80a117f))
		{
			pausestart = gettime();
			level waittill(#"hash_22962c7c3ae16f30");
			self.killstreakendtime = self.killstreakendtime + (gettime() - pausestart);
		}
		if(!is_true(self.var_478039e8) && gettime() >= self.halftime)
		{
			self namespace_f9b02f80::play_pilot_dialog_on_owner("timecheck", hardpointtype);
		...
		if(isdefined(self.var_8475558b) && isalive(self.var_8475558b) && waitresult._notify === "acquired_heli_target")
		{
			...
			var_c092cd08 = heli_get_protect_spot(self, self.origin, var_38cab71f, heli_team, hardpointtype, evasive);
		}
		else
		{
			var_c092cd08 = heli_get_protect_spot(self, protectdest, undefined, heli_team, hardpointtype, evasive);
		}
		waitresult = undefined;
