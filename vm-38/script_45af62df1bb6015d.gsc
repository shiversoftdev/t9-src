...
*/
function private autoexec function_60f9ba61()
{
	level notify(-711851095);
}
...
function function_d04f90d8(localclientnum)
{
	...
	if(!self.minigame.complete && (var_53044e8e && self flag::get(#"hash_3c27402259e4c18e") || (!var_53044e8e && function_18308bc1(localclientnum))))
	{
