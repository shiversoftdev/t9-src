...
*/
function private autoexec function_6ba10eda()
{
	level notify(1048816773);
}
...
function function_d370236e(target, var_7b23aa51, var_e544dc47, var_b1f9c3ce)
{
	...
	var_5134ce37 = 0;
	self thread function_c68d3621(target, var_7b23aa51);
	while(true)
	{
		if(!isalive(target))
		{
		...
		if(isdefined(pickedpoint))
		{
			...
			if(isdefined(pickedpoint))
			{
				...
				else
				{
					...
					self thread function_8b562a1(target, pickedpoint);
				}
				result = undefined;
				result = self waittill(#"hash_4f2aaaef2327c2a9", #"hash_1c5b621b87bcbdc6");
				/#
