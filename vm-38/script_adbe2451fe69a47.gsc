...
*/
function private autoexec function_fb0085b5()
{
	level notify(305132408);
}
...
function private function_6ff76fc6()
{
	...
	if(isdefined(var_7188db6d))
	{
		...
		var_d44b8c3e = (var_7188db6d.origin[0], var_7188db6d.origin[1], height);
	}
	else
	{
