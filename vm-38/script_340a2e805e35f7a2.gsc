...
function private function_35461e5f(index, row, var_be90d3da, falling)
{
	...
	item = function_62c0d32d(index, item_name, var_be90d3da, falling);
	if(isdefined(item))
	{
	...
	for(index = 1; index <= 5; index++)
	{
		...
		item = function_62c0d32d(index + items.size, item_name, var_be90d3da, falling);
		if(isdefined(item))
		{
			items[items.size] = item;
		}
...
function private function_62c0d32d(index, item_name, var_be90d3da, falling)
{
	...
	if(namespace_ad5a0cd6::function_6daf3c87(var_a6762160))
	{
		weaponinfo = namespace_ad5a0cd6::function_4ea13733(var_a6762160);
	...
	item = item_drop::function_fd9026e4(index, weapon, itemcount, var_aec6fa7f, var_f77e15f6.id, origin, angles, falling, var_be90d3da, undefined, undefined, undefined, undefined, undefined, undefined, var_e91aba42);
	if(isdefined(item))
	{
		item.spawning = 1;
	}
...
function private function_a0a5aec6(point, row, var_be90d3da)
{
	...
	if(var_a6762160.itemtype == #"vehicle")
	{
		...
		vehicle = undefined;
		if(namespace_ad5a0cd6::function_74e1e547(spawnpoint) && territory::is_inside(spawnpoint))
		{
			params = spawnstruct();
